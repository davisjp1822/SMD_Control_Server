...
/**
	@fn int parse_socket_input(const char *input, const int cl)
...
/**
	@fn void parse_smd_response_to_client_input(const char *input, const int cl)
...
/**
	@fn int write_to_client(const int cl, const char *message)
